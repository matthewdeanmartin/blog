...
- [Amazon Web Services Blog](https://aws.amazon.com/blogs/)
...
- [HashiCorp Blog (Terraform)](https://www.hashicorp.com/blog)
- [Terraform Blog](https://developer.hashicorp.com/terraform/blog)
- [AWS CDK Blog](https://aws.amazon.com/blogs/developer/tag/aws-cloud-development-kit/)
- [CDK Patterns](https://cdkpatterns.com/)

## CI/CD and Git Platforms

- [GitHub Engineering Blog](https://github.blog/engineering/)
- [GitHub Actions Blog](https://github.blog/category/actions/)
- [GitLab Blog](https://about.gitlab.com/blog/)
- [GitLab Engineering Blog](https://about.gitlab.com/handbook/engineering/blog/)
...
- [Astral Blog (uv, ruff)](https://astral.sh/blog)
- [uv Documentation and Updates](https://docs.astral.sh/uv/)

## Frontend (Angular)

- [Angular Blog](https://blog.angular.io/)
- [Angular Dev Blog (Medium)](https://medium.com/angular)

## Databases (Postgres)

- [PostgreSQL Official Blog](https://www.postgresql.org/blog/)
...
- [Docker Engineering Blog](https://www.docker.com/blog/tag/engineering/)
- [AWS Containers and ECS Blog](https://aws.amazon.com/blogs/containers/)
...
- [GNU Bash Announcements](https://lists.gnu.org/archive/html/bug-bash/)
- [Julia Evans](https://jvns.ca/)
- [Command Line Fu Blog](https://www.commandlinefu.com/blog)

## Go (Golang)

- [Go Blog](https://go.dev/blog/)
- [Go.dev Articles](https://go.dev/doc/articles)
