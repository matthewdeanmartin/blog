...
Summary: I wrote a library that serializes and deserializes markdown to and from python, but more in the style of pickle
...
`Union`s of `Union`s of `Union`s. It gets confused with generics, e.g. lists that can work with any contents.
